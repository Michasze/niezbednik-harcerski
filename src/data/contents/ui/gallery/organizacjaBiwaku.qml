...
HPSPage {
    ...
    ColumnLayout {
     ...
     ElementListyNoImage
     {
        color: "black"
        align: 0
        header: "Prowadzisz drużynę i chcesz zorganizować dla swoich harcerzy biwak?<br><br>
Pełnisz w drużynie jakąś funkcję i dostałeś za zadanie przygotowanie go? <br><br>
Chcesz zrobić coś dla większego środowiska niż jedna drużyna?<br><br>
A może po prostu interesuje Cię, jak wygląda zorganizowanie biwaku od strony technicznej?"
     ...
     ElementListyNoImage
     {
        color: "black"
        align: 0
        header: "W takim razie ten poradnik jest stworzony dla Ciebie! Bardzo częstym pytaniem przy organizowaniu biwaku, wycieczki czy wędrówki jest “kiedy zacząć przygotowania?”. Oczywiście im wcześniej, tym lepiej. Im większa impreza, tym wcześniej musisz znać listę uczestników, żeby powiadomić właściciela gruntu/budynku, w którym zamierzacie nocować. Najlepiej w ogóle mieć biwaki w planie pracy drużyny, choć nie zawsze jest to możliwe. Na potrzeby tego poradnika przyjmijmy, że przygotowanie 5 tygodni wcześniej dla grupy 10-20 osobowej wystarczy.<br><br>
Możemy zorganizować biwak o dowolnej tematyce. Pamiętajmy jednak, aby nasz pomysł absolutnie nie zagrażał zdrowiu ani życiu uczestników."
        alignH: Text.AlignJustify
     }
     ElementListyNoImage
     {
     ...
     ElementListyNoImage
     {
        ...
        HPSLista
        {
            label: "Budżet - Preliminarz biwaku"
        }
     ElementListyNoImage
     {
        color: "black"
     ...
     ElementListyNoImage
     {
        ...
        align: 0
        alignH: Text.AlignJustify
        header: "Przykładowo wyglądać to może tak:<br><br>
<b>Dzień pierwszy</b><br><br>
8:00-8:30 zbiórka na Pl. Zwycięstwa, przygotowanie do odjazdu<br><br>
8:30-9:30 dojazd na miejsce noclegu<br><br>
9:30-10:00 czas na zakwaterowanie, poprawienie ekwipunku<br><br>
10:00-11:30 piesza wędrówka nad jezioro Mokre<br><br>
11:30-12:30 gra terenowa wokół jeziora z elementami rywalizacji (zasady i przebieg w szczegółach)<br><br>
12:30-14:00 powrót do bazy<br><br>
14:00-15:00: obiad<br><br>
20:00-21:00: kolacja<br><br>
21:00-22:00 kominek<br><br>
22:00-00:00 cisza nocna<br><br>
<p>Dzień drugi</b><br><br>
00:00-7:00 Cisza nocna<br><br>
7:00-7:30 pobudka, zaprawa poranna [...]<br><br>
14:00-15:00 powrót pociągiem do miasta, pożegnanie"
     }
     ElementListyNoImage
     {
        color: "black"
        align: 0
        alignH: Text.AlignJustify
        header: "SZCZEGÓŁY I UWAGI: [Tutaj wpisujesz na przykład przebieg w/w gry terenowej albo inne rzeczy, które trzeba mieć na uwadze podczas trwania biwaku, np. że w bazie niebezpieczeństwo stwarza strych i należy go odpowiednio zabezpieczyć, aby nikt tam się przypadkiem nie dostał]<br><br>
I tak dalej. Nie każdy harmonogram musi wyglądać dokładnie w taki sposób, ale ważne jest, aby wszystkie elementy oraz w miarę możliwości ich szczegóły były w nim zawarte."
     }
     ElementListyNoImage
     {
        color: "black"
...
Każda zgoda powinna zawierać:"
     ...
     ElementListyNoImage
     {
        ...
        header: "<b>ZGODA NA UDZIAŁ DZIECKA W BIWAKU</b><br><br>
Wyrażam zgodę na udział mojego dziecka, ................ ......................(imię i nazwisko dziecka), w biwaku harcerskim pod namiotami w lesie w Tomisławiu (Smolarnia) w dniach 01-03. maja 2014, organizowanym przez 11 DH “Grot” i zobowiązuje się uiścić wpisowe w wysokości 15 zł do dnia 15. kwietnia 2014 r. ..................................... ..................................... (data, miejsce)<br><br>
 (podpis rodzica)"
     }
ElementListyNoImage
     {
...
ElementListyNoImage
     {
        ...
        align: 0
        alignH: Text.AlignJustify
        header: "<b>Rozliczenie finansowe</b><br><br>
Pamiętaj, aby po zakończeniu biwaku złożyć w Komendzie Hufca rozliczenie biwaku. Zadbaj również o sprzęt drużyny! Namioty i sprzęt pionierski powinny być wysuszone oraz zakonserwowane, tak aby mogły służyć jeszcze wiele lat."
     }
ElementListyNoImage
     {
        color: "royalblue"

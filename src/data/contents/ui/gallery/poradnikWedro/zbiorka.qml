...
4 <b>coś nowego, coś starego</b> - dobrą praktyką jest na początku zbiórki powtórzyć najważniejsze wiadomości z poprzedniej lub tak wpleść je w obecny temat żeby podczas wykonywania nowych zadań wykorzystali umiejętności zdobyte ostatnio.
             "
          }
                    ElementListyNoImage
          {

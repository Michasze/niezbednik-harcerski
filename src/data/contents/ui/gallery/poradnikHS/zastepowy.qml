...
HPSPage {
        ...
        ColumnLayout {
            ElementListyNoImage {
                color: "royalblue"
                header: "<h3>Kim jest dobry zastępowy</h3>"
            }
            ElementListyNoImage {
                color: "black"
                alignH: Text.AlignJustify
                header: "<p>Dobry zastępowy Jest przyjacielem swojego zastępu. Zastęp może się go poradzić w każdej sytuacji, zarówno związanej z wiedzą harcerską, jak i życiem codziennym.</p>

<p>Zastępowy jest jak starszy brat, siostra, która potrafi więcej i przekazuje tę wiedzę swojemu zastępowi. Rozwija się ze swoimi harcerzami z wewnętrznej potrzeby samorozwoju.</p>

<p>Zastępowy jest pomocny, pozytywny, potrafi zorganizować czas. Jest odpowiedzialny za siebie i swoich harcerzy. Ma poczucie obowiązku.</p>

<p>Każdy ma swoje wady - tak. Ale istotą bycia harcerzem jest dążenie do ideałów - chcąc kształtować postawy HS-ów, kształtujmy siebie.</p>

<p>Zastępowy jest WZOREM do naśladowania, niezależnie od sytuacji.</p>

<p>Pamiętajcie, że harcerze patrzą na Wasz przykład - jeżeli z Waszej strony jest obojętność, a czasem nawet okazywanie niechęci do pracy i wręcz chwalenie się swoimi wadami i lenistwem, zaprowadzi Was to absolutnie donikąd. Was i Wasz zastęp. Pamiętajcie, że macie pod pieczą garść osób, którym przewodzicie i również spoczywa na Was odpowiedzialność za ich rozwój.</p>

<p>„Druhno, a co jeśli moi harcerze już wszystko potrafią?”... Wielokrotnie słyszałam, że członkowie zastępu przerośli wiedzą zastępowego, lub że są tak wybitni że już nic więcej nie da się ich nauczyć.</p>

<p>BZDURA! Nie wątpię w wybitność harcerzy, ale zawsze jest coś, co można szlifować, zawsze jest coś do poznania, odkrycia, nawet nie stricte związanego ze stereotypowo pojmowaną wiedzą harcerską. Nie ograniczajcie się do wyrecytowania dat z historii harcerstwa. Posłuchajcie — lub przeprowadźcie — wywiady z seniorami lub choćby starszymi instruktorami harcerskimi, którzy pamiętają czasy starsze niż Wy. Jest harcyliard możliwości do przeprowadzenia zbiórki na jeden, pozomie drętwy i oklepany temat. Tak jak już pisałam - ogranicza Was tylko kreatywność.</p>

<p>A co, jeśli zastępowy nie jest w stanie przeprowadzić zbiórki na dany temat, bo zwyczajnie nie ma odpowiedniej do tego wiedzy? Nikt nie jest wszechwiedzący, to wiadome. Ale nie wiem czy wiecie - zastępowymi jesteście również dla własnego rozwoju. Jeśli przekażecie całą swoją wiedzę zastępowi, co dalej? Nie zatrzymujcie się w miejscu! Robiąc research, przygotowując się do zbiórki, szukając alternatywnych rozwiązań, rozwijacie również siebie. Nie osiadajcie na laurach twierdząc, że wszystko już potraficie i więcej się nie da.</p>

<p>Pamiętajcie, że członkowie zastępu też mają swoje zainteresowania - warto raz na jakiś czas pozwolić harcerzom poprowadzić zbiórkę zastępu na temat związany z ich hobby, pasją. To świetny sposób na integrację zastępu.</p>"
            }
            ElementListyNoImage {
                color: "royalblue"

...
QVector< Data > HPSCardModel::dane()
{
  ...
  m_dane
    ...
    << Data("Ekosystem w słoiku", "qrc:/contents/ui/img/applications-science.svg", "ekosystem.qml", tr("pomysły na zbiórki"), "Jak przygotować roślinkę w słoiku?")
    ...
    << Data("Zbiórka fotograficzna", "qrc:/contents/ui/img/camera-photo.svg", "fotograficzna.qml", tr("pomysły na zbiórki"), "Jak przygotować zbiórkę fotograficzną online?")

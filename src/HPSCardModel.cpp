...
QVector< Data > HPSCardModel::dane()
  ...
  m_dane
    ...
    << Data("ZHP", "qrc:/contents/ui/img/zhp.svg", "przyrzeczenieZHP.qml", "przyrzeczenia", "")
    << Data("ZHR", "qrc:/contents/ui/img/zhr.svg", "przyrzeczenieZHP.qml", "przyrzeczenia", "")
    ...
    << Data("Dawne roty przyrzeczenia", "image://icons/zwoj.svg,white", "histPrzyrzeczenia.qml", "przyrzeczenia", "")
    ...
    << Data("Poradnik dla zastępowych zastępów starszoharcerskich", "qrc:/contents/ui/img/HS.svg", "PoradnikHS.qml", "poradniki dla zastępowych", "Opracowanie: Kinga Żeglińska HO")
    << Data("Poradnik dla zastępowych zastępów wędrowniczych", "qrc:/contents/ui/img/Wedro.svg", "PoradnikWedro.qml", "poradniki dla zastępowych", "Opracowanie: Kinga Żeglińska HO")
    ...
    << Data("Historyczne prawa harcerskie", "image://icons/zwoj.svg,white", "histPrawa.qml", "prawo", "")

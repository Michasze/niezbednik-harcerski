...
//    << Data("Gra", "qrc:/contents/ui/img/HZNP.svg", "gra.qml", tr("historia"), "")
    ...
    << Data("Ekosystem w słoiku", "image://icons/applications-science.svg,white", "ekosystem.qml", tr("pomysły na zbiórki - harcerze"), "Jak przygotować roślinkę w słoiku?")
    << Data("Wiedźmiński LARP", "image://icons/wiedzmin.svg,white", "wiedzmin.qml", tr("pomysły na zbiórki - harcerze starsi"), "Zbiórka o tematyce Wiedźmina")
    << Data("Podróże małe i duże", "image://icons/edit-paste-in-place.svg,white", "podroze.qml", tr("pomysły na zbiórki - wędrownicy"), "Harcerskie wędrowanie tam i z powrotem.")
    << Data("Gra fabularna", "image://icons/kosci.svg,white", "gra_warsztaty.qml", tr("pomysły na zbiórki - harcerze, harcerze starsi"), "W klimatach bloku wschodniego.")
    << Data("Geoguessr", "image://icons/atmosphere.svg,white", "geoguessr.qml", tr("pomysły na zbiórki - harcerze"), "Pomysł na zdalną zbiórkę z ćwiczeniem spostrzegawczości.")
    << Data("Zbiórka fotograficzna", "image://icons/camera-photo.svg,white", "fotograficzna.qml", tr("pomysły na zbiórki - harcerze"), "Jak przygotować zbiórkę fotograficzną online?")
    << Data("Harcmaszyna", "image://images/harcmaszyna.jpg", "harcmaszyna.qml", tr("pomysły na zbiórki - ogólne"), "czyli harcerski Runmageddon")
    << Data("Zajęcia rozwijające kreatywność", "image://icons/zarowka.svg,white", "kreatywnosc.qml", tr("pomysły na zbiórki - wędrownicy"), "Jak pobudzić twórcze myślenie?")
    ...
    << Data("Oszczędnościowe triki na biwaki", "image://icons/bidon.svg,white", "oszczednosc.qml", "poradniki harcerskie", "pwd. Juliusz Idzikowski")
    ...
    << Data("Mała księga szyfrów", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega", tr("szyfry"), "Opracował: Piotr Parkita HO")
    << Data("Program szyfrujący", "image://icons/klucz.svg,white", "szyfrator", tr("szyfry"), "Autor: Osiołek")
    << Data("Kod Morse'a", "image://icons/klucz.svg,white", "szyfrator/morse.qml", "program szyfrujący", "")
    << Data("Cezar", "image://icons/klucz.svg,white", "szyfrator/Cezar.qml", "program szyfrujący", "")
    << Data("GA-DE-RY-PO-LU-KI", "image://icons/klucz.svg,white", "szyfrator/gade.qml", "program szyfrujący", "")
    << Data("Kaczor", "image://icons/klucz.svg,white", "szyfrator/kaczor.qml", "program szyfrujący", "")
    << Data("Mafeking", "image://icons/klucz.svg,white", "szyfrator/mafeking.qml", "program szyfrujący", "")
    << Data("Szyfr Bacona", "image://icons/klucz.svg,white", "szyfrator/bacon.qml", "program szyfrujący", "")
    << Data("Szyfr alfabetyczno-liczbowy", "image://icons/klucz.svg,white", "szyfrator/alfa-liczbowy.qml", "program szyfrujący", "")
    << Data("Szyfr rozbieżny", "image://icons/klucz.svg,white", "szyfrator/rozbiezny.qml", "program szyfrujący", "")
    << Data("Przedmowa", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/przedmowa.qml", tr("mała księga szyfrów"), "")
    << Data("Czekoladka", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/czeko.qml", tr("mała księga szyfrów"), "")
    << Data("GA-DE_RY-PO-LU-KI", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/gade.qml", tr("mała księga szyfrów"), "")
    << Data("Kaczor", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/kaczor.qml", tr("mała księga szyfrów"), "")
    << Data("Ułamkowy", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/ulamkowy.qml", tr("mała księga szyfrów"), "")
    << Data("Liczbowy | Matematyczny", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/liczbowy.qml", tr("mała księga szyfrów"), "")
    << Data("Cezar", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/cezar.qml", tr("mała księga szyfrów"), "")
    << Data("Alfabetyczno-Liczbowy", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/alfa-liczbowy.qml", tr("mała księga szyfrów"), "")
    << Data("Grupowy", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/grupowy.qml", tr("mała księga szyfrów"), "")
    << Data("Mafeking", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/mafeking.qml", tr("mała księga szyfrów"), "")
    << Data("Alfabet Morse'a", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/morse.qml", tr("mała księga szyfrów"), "")
    << Data("Szyfr Bacona", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/bacon.qml", tr("mała księga szyfrów"), "")
    << Data("Szyfr Ottendorfa | ksiązkowy", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/ksiazkowy.qml", tr("mała księga szyfrów"), "")
    << Data("Szyfr wsteczny", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/wsteczny.qml", tr("mała księga szyfrów"), "")
    << Data("Szyfr rozbieżny", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega/rozbiezny.qml", tr("mała księga szyfrów"), "")
    << Data("Znaki służb ZHP", "image://icons/przyrodzie.svg", "znaki.qml", "archiwum", "")
    << Data("Krzyż harcerski", "image://icons/krzyz.svg,white", "symbolikaKrzyz.qml", "symbolika", "")
    << Data("Lilijka", "image://icons/lilijka.svg,white", "symbolikaLilijka.qml", "symbolika", "")
    ...
    << Data("Fazy rozwoju drużynowego", "image://icons/Artykuly.svg,white", "pracaNauczyciela.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Zbiórki w terenie", "image://icons/Artykuly.svg,white", "zbiorkiWTerenie.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Jak promować harcerstwo?", "image://icons/Artykuly.svg,white", "promocja.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Tężyzna fizyczna", "image://icons/Artykuly.svg,white", "tezyzna.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Ekwipunek harcerski", "image://icons/Artykuly.svg,white", "nowoczesny.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Dlaczego kadra ma własne namioty?", "image://icons/Artykuly.svg,white", "kadraNamioty.qml", "artykuły", "Juliusz Idzikowski")
    << Data("Zjazd ZHP w Bydgoszczy - 30 lat minęło", "image://icons/Artykuly.svg,white", "zjazd.qml", "artykuły", "Ryszard Pacławski")
    << Data("Prawie wszystko o sprawnościach", "image://icons/Artykuly.svg,white", "prawie.qml", "artykuły", "Janusz Sikorski")
    ...
    << Data("Najlepsze metody parzenia kawy na wyjazdach harcerskich", "image://icons/moka.svg,white", "kawa.qml", "poradniki wyboru sprzętu", "")

...
//    << Data("Gra", "qrc:/contents/ui/img/HZNP.svg", "gra.qml", tr("historia"), "")
    ...
    << Data("Mała księga szyfrów", "image://icons/ksiega_szyfrow.svg,white", "malaKsiega.qml", tr("szyfry"), "Opracował: Piotr Parkita HO")
    << Data("Program szyfrujący", "image://icons/klucz.svg,white", "szyfrator.qml", tr("szyfry"), "Autor: Osiołek")
    << Data("Kod Morse'a", "image://icons/klucz.svg,white", "szyfrator/morse.qml", tr("szyfrator"), "")
    << Data("Cezar", "image://icons/klucz.svg,white", "szyfrator/Cezar.qml", tr("szyfrator"), "")
    << Data("GA-DE-RY-PO-LU-KI", "image://icons/klucz.svg,white", "szyfrator/gade.qml", tr("szyfrator"), "")
    << Data("Kaczor", "image://icons/klucz.svg,white", "szyfrator/kaczor.qml", tr("szyfrator"), "")
    << Data("Mafeking", "image://icons/klucz.svg,white", "szyfrator/mafeking.qml", tr("szyfrator"), "")
    << Data("Szyfr Bacona", "image://icons/klucz.svg,white", "szyfrator/bacon.qml", tr("szyfrator"), "")
    << Data("Szyfr alfabetyczno-liczbowy", "image://icons/klucz.svg,white", "szyfrator/alfa-liczbowy.qml", tr("szyfrator"), "")
    << Data("Szyfr rozbieżny", "image://icons/klucz.svg,white", "szyfrator/rozbiezny.qml", tr("szyfrator"), "")
